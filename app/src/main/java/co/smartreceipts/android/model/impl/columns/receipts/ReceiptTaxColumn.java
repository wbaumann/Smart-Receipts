...
public final class ReceiptTaxColumn extends AbstractColumnImpl<Receipt> {
    ...
    public ReceiptTaxColumn(int id, @NonNull SyncState syncState, long customOrderId) {
        super(id, ReceiptColumnDefinitions.ActualDefinition.TAX, syncState, customOrderId);
    }
