            ...
            return s3Manager.upload(file, OCR_FOLDER)
                    ...
                    .flatMap(recognitionResponse -> {
                        if (recognitionResponse != null && recognitionResponse.getRecognition() != null && recognitionResponse.getRecognition().getId() != null) {
                            ...
                            return Observable.error(new ApiValidationException("Failed to receive a valid recognition upload response. " + recognitionResponse.toString()));
                        }
                    })
                    ...
                    .flatMap(recognitionResponse -> {
                        ...
                        if (recognitionResponse != null &&
                            ...
                            return Observable.error(new ApiValidationException("Failed to receive a valid recognition complete response." + recognitionResponse.toString()));
                        }
                    })
                    .doOnNext(ignore -> {
