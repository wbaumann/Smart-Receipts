...
class AutoCompletePresenterTest {
    ...
    companion object {
        private val FIELD_1_RESULTS = arrayListOf(AutoCompleteResult("1a", Any()), AutoCompleteResult("1b", Any()))
        private val FIELD_2_RESULTS = arrayListOf(AutoCompleteResult("2a", Any()), AutoCompleteResult("2b", Any()))
    }
